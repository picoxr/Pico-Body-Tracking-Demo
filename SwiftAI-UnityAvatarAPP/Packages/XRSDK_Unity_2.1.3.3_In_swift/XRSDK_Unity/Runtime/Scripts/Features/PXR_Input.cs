...
namespace Unity.XR.PXR
{
    public static class PXR_Input
    {
        ...
        /// </param>
        /// <param name="frequency">Vibration frequency, which ranges from `50` to `500` Hz.</param>
        /// <param name="amplitude">Vibration amplitude. Its valid value ranges from `0` to `1`. The higher the value, the stronger the vibration amplitude.</param>
        ...
        /// <param name="cacheType">Whether to keep the controller vibrating while caching audio-based vibration data:
        ...
        /// </summary>
        /// <param name="phfText">The path to the PHF file.</param>
        /// <param name="sourceId">The source ID returned by `PauseHapticBuffer`,`ResumeHapticBuffer`,`UpdateHapticBuffer` or `StopHapticBuffer`.</param>
        /// <param name="vibrateType">The controller(s) to enable vibration for:
        /// * `0`: none
        /// * `1`: left controller
        /// * `2`: right controller
        ...
        /// * `No`: disable
        /// Once audio channel inversion is enabled, the left controller vibrates with the audio data from the right channel, and vice versa.</param>
        /// <param name="amplitudeScale">The vibration gain, the valid value range from `0` to `2`:
        /// * `0`: no vibration
        /// * `1`: standard amplitude
        /// * `2`: 2×standard amplitude</param>
        /// <returns>
        ...
        /// Stops audio-triggered vibration.
        /// </summary>
        /// <param name="sourceId">A reserved parameter, set it to the sourceId to stop the corresponding vibration,
        /// or set it to `0` to stop all vibrations.</param>
        /// <param name="clearCache">Whether to clear cache.</param>
        ...
        /// <summary>
        /// Pauses PHF and AudioClip vibration data.
        /// </summary>
        /// <param name="sourceId">The source ID returned by `SendHapticBuffer`.</param>
        /// <returns>
        /// * `0`: success
        /// * `-1`: failure
        /// </returns>
        ...
        /// <summary>
        /// Resumes PHF and AudioClip vibration data.
        /// </summary>
        /// <param name="sourceId">The source ID returned by `SendHapticBuffer`.</param>
        /// <returns>
        /// * `0`: success
        ...
        /// Plays cached audio-triggered vibration data.
        /// </summary>
        /// <param name="sourceId">The source ID returned by `SendHapticBuffer`when cache not clear.</param>
        /// <returns>
        /// * `0`: success
        /// * `-1`: failure
        /// </returns>
        ...
        public static int SetBodyTrackingStaticCalibState(int state)
        {
            return PXR_Plugin.Controller.UPxr_SetBodyTrackingStaticCalibState(state);
        }
        ...
        public static int GetBodyTrackingImuData(BodyTrackerType bodyTrackerType, ref BodyTrackerImu bodyTrackerImu)
        {
            return PXR_Plugin.Controller.UPxr_GetBodyTrackingImuData((UInt32)bodyTrackerType, ref bodyTrackerImu);
        }
