...
namespace Unity.XR.PXR
{
    ...
    public class PXR_System
    {
        ...
        /// <summary>Sets a CPU or GPU level for the device.</summary>
        /// <param name="which">Choose to set a CPU or GPU level:
        /// * `CPU`
        /// * `GPU`
        /// </param>
        ...
        /// <summary>Gets the device's CPU or GPU level.</summary>
        /// <param name="which">Choose to get CPU or GPU level:
        /// * `CPU`
        /// * `GPU`
        /// </param>
        /// <returns>
